...
content = content.replace(/>24-Hr</, ">6<");
content = content.replace(/>Partner SLA</, ">Core Industries<");
content = content.replace(/>0</, ">100%<");
content = content.replace(/>Junior Pass-Throughs</, ">Technology Focused<");
