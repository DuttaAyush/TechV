          ...
          <div>
            ...
            <div className="grid lg:grid-cols-12 gap-8 sm:gap-10 items-center bg-white border border-[#e5dccf] rounded-xl p-5 sm:p-8 md:p-12 shadow-sm">
              <div className="lg:col-span-7 space-y-4 sm:space-y-5">
                ...
                <p className="text-[14px] sm:text-[15px] text-[#6b6255] leading-relaxed font-normal">
              ...
              <div className="lg:col-span-5 relative h-[250px] sm:h-[300px] md:h-[360px] rounded-xl overflow-hidden bg-[#1c1a18]">
                <Image
                ...
                <div className="absolute bottom-4 sm:bottom-6 left-4 sm:left-6 right-4 sm:right-6">
                  ...
                  <p className="text-[12.5px] sm:text-[13.5px] text-white font-medium italic">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
              {milestones.map((m, idx) => (
                <div
                  key={idx}
                  className="hover-VRTANS-border bg-white border border-[#e5dccf] rounded-xl p-5 sm:p-6 shadow-sm hover:shadow-md transition-all duration-300"
                >
                  <span className="text-3xl sm:text-4xl font-extrabold text-[#1c1a18] block mb-1">{m.metric}</span>
                  <span className="text-[11px] sm:text-[12px] font-extrabold uppercase tracking-wider text-[#784813] block mb-1.5 sm:mb-2 truncate">{m.label}</span>
                  <p className="text-[12.5px] sm:text-[13px] text-[#6b6255] font-normal leading-relaxed">{m.desc}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
              {leaders.map((l, idx) => (
                <div
                  key={idx}
                  className="hover-VRTANS-border bg-white border border-[#e5dccf] rounded-xl p-5 sm:p-6 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col justify-between"
                >
                  <div>
                    <div className="flex items-center gap-3 mb-3 sm:mb-4">
                      ...
                      <div>
                        <h3 className="text-[15px] sm:text-[16px] font-bold text-[#1c1a18] tracking-tight">{l.name}</h3>
                        <p className="text-[10px] sm:text-[11.5px] uppercase tracking-wider text-[#784813] font-extrabold">{l.role}</p>
                      </div>
                    </div>
                    <p className="text-[13px] sm:text-[13.5px] text-[#595248] font-normal leading-relaxed mb-4 sm:mb-6">{l.bio}</p>
                  </div>

                  <div className="pt-3 border-t border-[#f2ece2] flex items-center justify-between text-[11px] sm:text-[12px] font-bold text-[#5e8817]">
