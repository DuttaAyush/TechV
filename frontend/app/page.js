...
const iconMap = { Globe, Smartphone, Code, TrendingUp, Users, Briefcase, MonitorCheck, LineChart, Cpu, Cloud, ShieldCheck, Workflow, Database, Layers, CheckCircle, Sparkles, Mail, Phone, Clock, Lock, Target, Award };
                ...
                <div className="relative z-10 flex-1 flex flex-col">
                  <div className="flex items-center gap-2.5 sm:gap-3.5 mb-3 sm:mb-4 min-w-0">
                    <div className="flex h-9 w-9 sm:h-11 sm:w-11 shrink-0 items-center justify-center rounded-xl bg-[#071326] text-[#D4AF37] font-bold group-hover:bg-[#D4AF37] group-hover:text-black transition-colors shadow-sm">
                      {iconMap[s.icon] ? (() => { const IconComp = iconMap[s.icon]; return <IconComp className="h-4.5 w-4.5 sm:h-5.5 sm:w-5.5" /> })() : <Globe className="h-4.5 w-4.5 sm:h-5.5 sm:w-5.5" />}
                    </div>
